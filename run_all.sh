...
# [photo]
python train_clenshaw.py  --dataset photofull --early-stop  --udgraph --self-loop         --loss nll  --n-cv 20 --log-detail --log-detailedCh --dropout 0.3 --dropout2 0.7 --lamda 2.0 --lr1 0.005 --lr2 0.03 --lr3 0.001 --momentum 0.95 --n-layers 4 --wd1 1e-4 --wd2 1e-4 --wd3 1e-7
